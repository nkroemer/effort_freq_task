...
text_instr =  ['In manchen Durchgängen können Sie Kalorien gewinnen. Im Anschluss an die Aufgabe bekommen Sie ein entsprechend reichhaltiges Frühstück. \n\nFolgende Bedingungen gibt es:'];
        [pos.text.x,pos.text.y,pos.text.bbox] = DrawFormattedText(w, text_instr, 'center', setup.ScrHeight/5, color.black,60, [], [], 1.2);   
